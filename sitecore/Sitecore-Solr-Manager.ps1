...
class Solr
{
    ...
    [string[]] GetExistingConfigSets()
    {
        return (Get-ChildItem -Path ([Constants]::GetInstance().IndexesWorkingDir) -Directory | Select-Object -ExpandProperty Name)
    }
...
class SearchStaxCollectionManager
{
    ...
    [void] Execute()
    {
        ...
        $this.Solr.GetExistingConfigSets() + ($CollectionSource | ForEach-Object { [string]::Format("{0}{1}", $this.IndexPrefix, $_) }) | Select-Object -Unique | ForEach-Object {
